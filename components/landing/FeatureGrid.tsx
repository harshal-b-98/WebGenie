...
const features = [
  ...
  },
  {
    ...
    description:
      "Create and manage multiple websites from one dashboard. Perfect for agencies and freelancers.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
            ...
            {features.map((feature, index) => (
              ...
              >
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  <div
                    className={`absolute left-0 top-0 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r ${feature.gradient} text-white shadow-lg transition-transform group-hover:scale-110`}
                  >
                    {feature.icon}
                  </div>
                  {feature.name}
